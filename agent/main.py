...
from healthcoach_agent import get_healthcoach_agent
...
app = FastAPI(
    ...
    version="1.0",
    description="Health Coach Agent API that retrun the chatbot response",
)
...
cityhub_agent = get_healthcoach_agent()

RESPONSES = get_response_schema()

@app.post("/askagent", response_model=ChatbotResponse, responses=RESPONSES)
